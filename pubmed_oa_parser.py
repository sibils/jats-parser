...
def parse_pubmed_xml(path, include_path=False, nxml=False):
    ...
    if figs is not None:
        for fig in figs:
            ...
            dict_caption = {'fig_caption': caption,
                            'fig_id': fig_id,
                            'fig_label': fig_label,
    ...
    # Ju paragraphs
    for fig in tree.xpath("//body//fig"):
    ...
    for paragraph in paragraphs:
        ...
        if section is not None:
            ...
            section = ''
        p_dict = {"section":section,"text":paragraph_text}
        paragraphs_list.append(p_dict)
    ...
    dict_out = {'full_title': full_title.strip(),
                ...
                'pmcid': "PMC"+dict_article_meta['pmc'],
                '_id': "PMC"+dict_article_meta['pmc'],
